...
class Pest
{
     ...
     * @throws Pest_Curl_Meta
     */
    private function doRequestCrm($curl)
    {
    ...
    public function post($url, $data, $headers = array())
    {
        ...
        $body = substr($this->doRequest($curl),3);
    ...
    public function post_formUrlencoded($url, $data, $headers = array())
   {
       //$data = $this->prepData($data);
     ...
     * @return string
     */
     public function postEad($url, $data, $headers = array())
     {
         $data = $this->prepData($data);
     ...
     * @return string
     */
     public function postCrm($url, $data, $headers = array())
     {
         $data = $this->prepData($data);
